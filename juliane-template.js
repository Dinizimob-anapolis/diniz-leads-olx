...
<div class="toolbar">
  ...
  <button class="add-contato-btn" id="btn-analytics" onclick="window.location.href='/analytics'" style="background:#fff;color:#7c5cff;border:1px solid #7c5cff;box-shadow:none;">📊 Analytics</button>
